...
> > The Technical Communication section is mainly comprised of essays I wrote on various topics and exercises in grammar and punctuation.
## Projects
> > The two projects presented are related to a Veterinary Anatomy and Physiology eLearning application I created. <br><br>
> > The first project, "Usability Study for an Animal Anatomy & Physiology eLearning application", includes documentation for the usability study I conducted on the application.<br><br>
> > The second project, "Social Media and Gaming", focuses on educational gaming and includes a game I created, research on testing educational game software, and a Flickr gallery depicting Participatory Culture and Social Media.
...
> > My effort on this project outperformed the course requirements and led to a Merit Award from the MSPTC department.<br><br>
...
> > Originally implemented in WordPress, I proposed a social media game to accompany my animal anatomy and physiology eLearning application presented above. <br>
...
> > ##### Flickr Gallery
> > https://www.flickr.com/photos/60721421@N07/galleries/72157626372437622/
> > ##### Presentation
